...
.2 setup.py.
.2 fairy.
.3 $\operatorname{\_\_init\_\_.py}$.
.3 $\operatorname{\_\_main\_\_.py}$.
.3 $\operatorname{\_speedups.c}$.
.3 $\operatorname{\_speedups.pyx}$.
.3 faireanalysis.py.
.2 README.rst.
}
...
\begin{figure}
\centering
\includegraphics[scale=0.52]{mixture_model.png}
...
Время работы программы на эмбриональных стволовых клетках H1-hESC и клетках рака груди $\operatorname{ENCFF000TJJ.bam}$, $\operatorname{ENCFF000TJK.bam}$ составило 15 мин. и 31 с.%$\operatorname{MM}$ мин. $\operatorname{SS}$ c.
